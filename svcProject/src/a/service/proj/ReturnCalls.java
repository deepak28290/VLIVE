...
public class ReturnCalls {
	 ...
	 @GET
	  ...
	  @Produces(MediaType.APPLICATION_JSON)
	  @Consumes(MediaType.APPLICATION_JSON)
	  public String crtUserData(@QueryParam(value = "userid") String userid,@QueryParam(value = "boardingpoint") String boardingpoint,@QueryParam(value = "droppoint") String droppoint,@QueryParam(value = "busnumb") String busnumb) throws ClientProtocolException, IOException {
		String boord_coord;
		String drop_coord;
		boord_coord=VolvoUtil.getCoordFromLoc(boardingpoint);
		drop_coord=VolvoUtil.getCoordFromLoc(droppoint);
